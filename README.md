...
| Dữ liệu gửi AI & cách luận | 872 phép kiểm: báo cáo **tự khai đúng** hệ nhà × hệ hoàng đạo (quét đủ 12 × 7 = 84 cặp, không còn nhãn ghi cứng), khai ayanamsa, ghi chú đổi hệ nhà ngoài vòng cực, câu hỏi nằm đầu và sống sót sau trần ký tự, khối bầu trời thật (có thì đưa, không có thì không bịa), điểm ảo quy về đúng hệ, đủ 12 cusp/giới tính/giờ sinh địa phương/sao cố định, góc chiếu xếp theo orb, `SYSTEM_PROMPT` dặn đúng những gì dữ liệu cho phép, bộ luận giải nội bộ nêu đúng biến môi trường + hệ quy chiếu | 0 lỗi |
